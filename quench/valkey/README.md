...
```bash
gh attestation verify oci://ghcr.io/quenchworks/images/valkey \
  --owner quenchworks
```
...
You get one primary (StatefulSet ordinal 0 at bootstrap), N read replicas, and a 3-node **Valkey
...
The valkey and valkey-sentinel containers stay **shell-free**: the rewritable Sentinel config and
...
valkey containers then consume.
